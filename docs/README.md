...
| <a id="cc_archive-implementation_deps"></a>implementation_deps |  (Not yet implemented) cc_common attribute for passing on implementation_deps is currently private.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="cc_archive-linkshared"></a>linkshared |  (Will not implemented) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `False`  |
| <a id="cc_archive-linkstamp"></a>linkstamp |  (Not yet implemented)   | List of strings | optional |  `[]`  |
| <a id="cc_archive-linkstatic"></a>linkstatic |  (Will not implement) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `True`  |
...
| <a id="cc_archive-module_interfaces"></a>module_interfaces |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_archive-nocopts"></a>nocopts |  (Not yet implemented)   | String | optional |  `""`  |
| <a id="cc_archive-reexport_deps"></a>reexport_deps |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="cc_archive-textual_hdrs"></a>textual_hdrs |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_archive-win_def_file"></a>win_def_file |  (Will not implement) Support for Windows is not in scope of current development.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="cc_bin-linkshared"></a>linkshared |  (Will not implemented) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `False`  |
| <a id="cc_bin-linkstatic"></a>linkstatic |  (Will not implement) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `True`  |
| <a id="cc_bin-local_defines"></a>local_defines |  List of defines to add to the compile line. Subject to "Make" variable substitution and Bourne shell tokenization. Each string, which must consist of a single Bourne shell token, is prepended with -D and added to the compile command line for this target, but not to its dependents.   | List of strings | optional |  `[]`  |
| <a id="cc_bin-malloc"></a>malloc |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@bazel_tools//tools/cpp:malloc"`  |
| <a id="cc_bin-module_interfaces"></a>module_interfaces |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_bin-nocopts"></a>nocopts |  (Not yet implemented)   | String | optional |  `""`  |
| <a id="cc_bin-reexport_deps"></a>reexport_deps |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="cc_bin-win_def_file"></a>win_def_file |  (Will not implement) Support for Windows is not in scope of current development.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="cc_hdrs-module_interfaces"></a>module_interfaces |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_hdrs-win_def_file"></a>win_def_file |  (Will not implement) Support for Windows is not in scope of current development.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
...
| <a id="cc_so-alwayslink"></a>alwayslink |  (Not yet implemented)   | Boolean | optional |  `True`  |
...
| <a id="cc_so-exports_filter"></a>exports_filter |  (Not yet implemented)   | List of strings | optional |  `[]`  |
| <a id="cc_so-hdrs_map"></a>hdrs_map |  Dictionary describing paths under which header files should be avaiable as.<br><br>Keys are simple glob pathnames, used to match agains all header files avaiable in the rule. Values are list of paths to which matching header files should be mapped.<br><br>'{filename}' is special token used to signify to matching file name.<br><br>For example: '"**/*o.hpp": ["a/{filename}"]' - will ensure all hpp files with names ending with '0' will be also avaible as if they were placed in a subdirectory.   | <a href="https://bazel.build/rules/lib/dict">Dictionary: String -> List of strings</a> | optional |  `{}`  |
| <a id="cc_so-implementation_deps"></a>implementation_deps |  (Not yet implemented) cc_common attribute for passing on implementation_deps is currently private.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="cc_so-linkshared"></a>linkshared |  (Will not implemented) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `False`  |
| <a id="cc_so-linkstamp"></a>linkstamp |  (Not yet implemented)   | List of strings | optional |  `[]`  |
| <a id="cc_so-linkstatic"></a>linkstatic |  (Will not implement) As there is clear distinction between targets that are SOLs and archives, the parameter is not applicable.   | Boolean | optional |  `True`  |
| <a id="cc_so-local_defines"></a>local_defines |  List of defines to add to the compile line. Subject to "Make" variable substitution and Bourne shell tokenization. Each string, which must consist of a single Bourne shell token, is prepended with -D and added to the compile command line for this target, but not to its dependents.   | List of strings | optional |  `[]`  |
| <a id="cc_so-malloc"></a>malloc |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `"@bazel_tools//tools/cpp:malloc"`  |
| <a id="cc_so-module_interfaces"></a>module_interfaces |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_so-nocopts"></a>nocopts |  (Not yet implemented)   | String | optional |  `""`  |
...
| <a id="cc_so-textual_hdrs"></a>textual_hdrs |  (Not yet implemented)   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
| <a id="cc_so-win_def_file"></a>win_def_file |  (Will not implement) Support for Windows is not in scope of current development.   | <a href="https://bazel.build/concepts/labels">Label</a> | optional |  `None`  |
